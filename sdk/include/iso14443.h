...
// Function:
//		write nfc reader chip register
// Input:
//		fd        ----  device id, return from mif_open(...)
...
//		-1  ----- fail, please check "errno" for actual error code
//				EINVAL	---- invalid argument
int nfc_write_register(int fd, uint8_t reg_addr, uint8_t reg_value);

// Function:
//		read nfc reader chip register
// Input:
//		fd        ----  device id, return from mif_open(...)
//      reg_addr  ----  register address
// Output:
...
//		-1  ----- fail, please check "errno" for actual error code
//				EINVAL	---- invalid argument
int nfc_read_register(int fd, uint8_t reg_addr, uint8_t *reg_value);

// Function:
//		get nfc reader chip type
// Input:
//		fd        ----  device id, return from mif_open(...)
// Output:
//      chip_type ----  0x01 : pn512
// Return Value:
//		0   ----- success
//		-1  ----- fail, please check "errno" for actual error code
//				EINVAL	---- invalid argument
int nfc_get_chip_type(int fd, uint8_t *chip_type);
